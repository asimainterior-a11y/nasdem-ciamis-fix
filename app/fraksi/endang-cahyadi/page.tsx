...
export default function ProfilEndangCahyadi() {
  const stats = [
    { label: "Dapil", value: "CIAMIS 2" },
    { label: "Jabatan", value: "Wakil Ketua" },
    { label: "Komisi", value: "Komisi B" },
    { label: "Fraksi", value: "NasDem" },
  ];

  const highlights = [
    { title: "Pemberdayaan Ekonomi", desc: "Mendorong program UMKM lokal untuk naik kelas di wilayah Ciamis." },
    { title: "Infrastruktur Desa", desc: "Mengawal pemerataan pembangunan jalan dan fasilitas umum di pedesaan." },
    { title: "Pertanian Modern", desc: "Advokasi bantuan alat tani dan ketersediaan pupuk bagi petani lokal." },
  ];

  const news = [
    { 
      title: "Endang Cahyadi Hadiri Pelatihan UMKM di Dapil 2", 
      date: "28 April 2026", 
      img: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=500" 
    },
    { 
      title: "Fraksi NasDem Kawal Pembangunan Jembatan Pedesaan", 
      date: "22 April 2026", 
      img: "https://images.unsplash.com/photo-1513828583688-c52646db42da?auto=format&fit=crop&q=80&w=500" 
    },
    { 
      title: "Rapat Anggaran: Prioritaskan Subsidi Pupuk Petani", 
      date: "18 April 2026", 
      img: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=500" 
    },
    { 
      title: "Kunjungan Kerja Komisi B ke Pasar Tradisional Ciamis", 
      date: "12 April 2026", 
      img: "https://images.unsplash.com/photo-1533900298318-6b8da08a523e?auto=format&fit=crop&q=80&w=500" 
    },
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="relative z-10 rounded-2xl overflow-hidden border-2 border-[#FFC20E]/30 shadow-[0_0_50px_rgba(0,0,0,0.3)]">
              <img 
                src="/images/endang-cahyadi-f.jpeg" 
                alt="Endang Cahyadi" 
          ...
          >
            <div className="space-y-2">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-none pt-4">
                ENDANG <br /> <span className="text-[#FFC20E]">CAHYADI</span>
              </h1>
            </div>

            <p className="text-xl text-white/90 font-light leading-relaxed max-w-xl italic border-l-4 border-[#FFC20E] pl-6">
              "Politik adalah jalan pengabdian. Fokus saya adalah memastikan setiap kebijakan daerah berdampak langsung pada kesejahteraan dapur masyarakat."
            </p>
            ...
            {highlights.map((item, idx) => (
              ...
              >
                <div className="w-14 h-14 bg-[#FFC20E] text-[#19367F] rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-[#FFC20E]/20">
                  <Icon icon={idx === 0 ? "solar:shop-bold" : idx === 1 ? "solar:road-bold" : "solar:leaf-bold"} width="30" />
                </div>
      ...
      <section className="py-20 bg-[#FFC20E] text-[#19367F]">
        <div className="max-w-5xl mx-auto px-6 text-center">
           ...
           <h2 className="text-2xl md:text-4xl font-black tracking-tight leading-tight uppercase">
             "Mari bersama kita wujudkan Ciamis yang lebih mandiri dan sejahtera melalui kerja nyata di parlemen."
           </h2>
           <p className="mt-8 font-bold tracking-[0.3em] text-sm">- ENDANG CAHYADI</p>
        </div>
      </section>
